...
<div class="top">
    ...
    <div class="nav">
    	<div class="nav_in">
        	<ul>
            	<li class="now"><a href="<?php echo $tag['path.root']; ?>/">首页</a></li>
                <?php nav_main()?>
            </ul>
        </div>
		<script>
...
<div class="bottom_b">
	<div class="bottom_b_in">
    	<div class="bottom_l">
        	<ul>
            	<li class="first">产品推荐</li>
				<?php doc_focus('8',5,1,0,0,true,'id',0)?>
                <div class="clear"></div>
            </ul>
        	<ul>
            	<li class="first">公司简介</li>
            	<?php doc_focus('7',5,1,0,0,true,'id',0)?>
                <div class="clear"></div>
            </ul>
        	<ul>
            	<li class="first">法律信息</li>
            	<?php doc_focus('6',5,1,0,0,true,'id',0)?>
                <div class="clear"></div>
            </ul>
			<div class="clear"></div>
        </div>
